...
exports["default"] = cleanFilePathSnapshot;
...
function cleanFilePathSnapshot(snapshot) {
  if (typeof snapshot === 'string') {
    return snapshot.replaceAll(dirname, '~');
  } else if (Array.isArray(snapshot)) {
    return snapshot.map(cleanFilePathSnapshot);
  } else if ((0, _typeof2["default"])(snapshot) === 'object') {
    return Object.keys(snapshot).reduce(function (acc, key) {
