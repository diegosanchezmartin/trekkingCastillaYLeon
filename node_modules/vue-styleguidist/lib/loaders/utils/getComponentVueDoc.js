...
function getComponentVueDoc(source, file) {
  var _descriptor$customBlo;

  var descriptor = (0, _parseVue["default"])(source);
  var docBlocks = (_descriptor$customBlo = descriptor.customBlocks) === null || _descriptor$customBlo === void 0 ? void 0 : _descriptor$customBlo.filter(function (block) {
    return block.type === 'docs';
  })[0];

  if (docBlocks !== null && docBlocks !== void 0 && docBlocks.src) {
    var jsFilePath = path.join(path.dirname(file), docBlocks.src);
    return readSeparateScriptFile(jsFilePath);
  } else if (docBlocks !== null && docBlocks !== void 0 && docBlocks.content) {
