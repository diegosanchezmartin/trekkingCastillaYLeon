...
var CLIENT_CONFIG_OPTIONS = ['title', 'tocMode', 'version', 'showCode', 'showUsage', 'showSidebar', 'previewDelay', 'theme', 'styles', 'compilerConfig', 'editorConfig', 'ribbon', 'pagePerSection', 'mountPointId', 'jsxInExamples', 'jssThemedEditor', 'locallyRegisterComponents']; // const emptyFunctionAst = {}
          ...
          case 8:
            ...
            setVariableValueToObjectInFile = function setVariableValueToObjectInFile(memberName, varName) {
              ...
              if (typeof configMember === 'string') {
                ...
                styleContext.push((0, _resolveESModule["default"])(configMember, varName)); // Finally assign the calculated value to the member of the clone
