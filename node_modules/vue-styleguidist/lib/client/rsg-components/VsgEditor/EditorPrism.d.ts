...
declare type EditorProps = Omit<UnconfiguredEditorProps, 'jssThemedEditor' | 'jsxInExamples'>;
declare const _default: React.ComponentType<Omit<EditorProps, "classes">>;
