...
var USER_WEBPACK_CONFIG_NAMES = ['./webpack.config.js', './webpackfile.js', '@vue/cli-service/webpack.config.js'];
/**
...
function findUserWebpackConfig(_ref) {
  var rootDir = _ref.rootDir;

  // Check in the root folder
  var _iterator = _createForOfIteratorHelper(USER_WEBPACK_CONFIG_NAMES),
      _step;
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      } catch (e) {// if file not found, eat the error
      }
    }
  } catch (err) {
    _iterator.e(err);
