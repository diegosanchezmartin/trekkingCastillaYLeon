 ...
 */
export declare function defineConfig(config: StyleguidistConfig): StyleguidistConfig;
/**
 ...
 */
export declare function defineEnhanceApp(enhance: (app: App) => void): (app: App) => void;
